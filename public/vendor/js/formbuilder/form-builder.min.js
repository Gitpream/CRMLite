 ...
 * 
 * [CRMLITE] - Revised 16 Aug 2021 changed [ <span class="control-icon">${i}</span> ] to [ <span class="control-icon ${i}"></span> ]
 *              so that we can use the icons to identify the custom field on the left panel. DO NOT CHANGE THIS
 */
! function (e) {
    "use strict";
    ! function (e) {
        ...
        r.m = e, r.c = t, r.d = function (e, t, o) {
            ...
            return Object.prototype.hasOwnProperty.call(e, t)
                ...
                const s = function (e, t = !1) {
                    ...
                    u = e => Object.entries(e).map(([e, t]) => c(e) && Object.values(f(e, t)).join("")).filter(Boolean).join(" "),
                    f = (e, t) => {
                        let r;
                    ...
                    A = e => {
                        ...
                        if (t) {
                            ...
                            for (let t = 0; t < e.length; t++) {
                                ...
                                n && n.length && (o.values = x(n)), i && i.length && (o.userData = O(i)), r.push(o)
                            }
                        }
                        return r
                    },
                    ...
                    S = (e, t) => {
                        const r = jQuery;
                        let o = [];
                        return Array.isArray(e) || (e = [e]), L(e) || (o = jQuery.map(e, e => {
                            const r = {
                                dataType: "script",
                                cache: !0,
                                url: (t || "") + e
                    ...
                    D = (t, r) => {
                        Array.isArray(t) || (t = [t]), t.forEach(t => {
                            let o = "href",
                                n = t,
                                i = "";
                            if ("object" == typeof t && (o = t.type || (t.style ? "inline" : "href"), i = t.id, t = "inline" == o ? t.style : t.href, n = i || t.href || t.style), !L(n, "css")) {
                                if ("href" == o) {
                    ...
                    B = (e, t) => {
                        ...
                        for (const o in t) r.hasOwnProperty(o) && (Array.isArray(t[o]) ? r[o] = Array.isArray(e[o]) ? E(e[o].concat(t[o])) : t[o] : "object" == typeof t[o] ? r[o] = B(e[o], t[o]) : r[o] = t[o]);
                        return r
                    },
                ...
                const V = {
                    ...
                    escapeAttr: q,
                    escapeAttrs: e => {
                        for (const t in e) e.hasOwnProperty(t) && (e[t] = q(e[t]));
                        return e
                    },
                    escapeHtml: k,
                    forceNumber: M,
                    ...
                    on(e) {
                        const t = {
                            ...
                            render: e => {
                                ...
                                this.css && Object(o.m)(this.css), this.js && !Object(o.p)(this.js) ? Object(o.l)(this.js).done(t) : t()
                            }
                        };
                        return e ? t[e] : t
                    }
                ...
                function h(e, t) {
                    ...
                    } else r = c(t), o = p.bind(null, r, t), n = function () {
                        ! function (e) {
                ...
                const n = (e, t) => {
                    ...
                    if (e.className) {
                        ...
                        o = o.filter(e => /^col-(xs|sm|md|lg)-([^\s]+)/.test(e) || e.startsWith("row-")), o && o.length > 0 && (r += " " + o.join(" "));
                ...
                class i {
                    ...
                    build(e, t, r) {
                        ...
                        const c = this.processTemplate(s, i.field, l, a);
                ...
                class a extends n.a {
                    ...
                    build() {
                        ...
                        delete s.name;
                        const d = [this.markup("input", null, s), this.markup("input", null, c)],
                            u = t.map(e => {
                                const t = e.label,
                                    r = {
                                        events: {
                    ...
                    build() {
                        ...
                        if ((c.multiple || "checkbox-group" === i) && (c.name = c.name + "[]"), "checkbox-group" === i && c.required && (this.onRender = this.groupRequired), delete c.title, r) {
                            ...
                            for (let t = 0; t < r.length; t++) {
                                ...
                                if (u.id = `${c.id}-${t}`, u.selected && !n || delete u.selected, void 0 !== o && u.value === o && (u.selected = !0), f) {
                                    const t = this.markup("option", document.createTextNode(a), u);
                                    e.push(t)
                                } else {
                                    const t = [a];
                                    let r = "formbuilder-" + d;
                                    l && (r += "-inline"), u.type = d, u.selected && (u.checked = "checked", delete u.selected);
                                    const o = this.markup("input", null, Object.assign({}, c, u)),
                                        n = {
                                            for: u.id
                                        };
                ...
                class y {
                    ...
                    prepData(t) {
                        ...
                        return 0 !== t.childNodes.length && Object(p.i)(t.childNodes, (function (t, i) {
                            ...
                            if (!l.hasClass("disabled-field")) {
                                ...
                                if (t = Object.assign({}, t, n.getAttrVals(i)), t.subtype)
                                    if ("quill" === t.subtype) {
                                ...
                                if (s.length && (t.role = s.join(",")), t.className = t.className || t.class, t.className) {
                                    const e = /(?:^|\s)btn-(.*?)(?:\s|$)/g.exec(t.className);
                                    e && (t.style = e[1])
                                }
                                t = Object(p.A)(t);
                                t.type && t.type.match(o.optionFieldsRegEx) && (t.values = n.fieldOptionData(l)), r.push(t)
                            }
                        })), r
                    }
                    getData(e) {
                    ...
                    getAttrVals(t) {
                        ...
                        return Object(p.i)(o, t => {
                            const n = o[t],
                                ...
                                l = [
                                    [n.attributes.contenteditable, () => "xml" === m.a.opts.dataType ? Object(p.g)(n.innerHTML) : n.innerHTML],
                    ...
                    classNames(t, r) {
                        ...
                        const c = Object(p.B)(a).join(" ").trim();
                        return o.value = c, c
                    }
                    closeConfirm(e, t) {
                    ...
                    confirm(e, t, r = !1, o = "") {
                        ...
                        const c = Object(p.q)("div", [s, a], {
                            className: "button-wrap"
                        });
                        o = "form-builder-dialog " + o;
                        const u = Object(p.q)("div", [e, c], {
                            className: o
                        });
                    ...
                    removeField(t, r = 250) {
                        ...
                        const c = m.a.opts.typeUserEvents[a.type];
                    ...
                    processActionButtons(e) {
                        ...
                        let n = t;
                        const i = this.data;
                        n = n ? d.a.current[n] || n : o.id ? d.a.current[o.id] || Object(p.d)(o.id) : "", o.id ? o.id = `${i.formID}-${o.id}-action` : o.id = `${i.formID}-action-${Math.round(1e3*Math.random())}`;
                    ...
                    processSubtypes(e) {
                        ...
                        const r = b.a.getRegisteredSubtypes(),
                            o = Object.entries(r).reduce((e, [r, o]) => (e[r] = t[r] && Object(p.y)(t[r], o) || o, e), {}),
                            n = {};
                        for (const e in o)
                ...
                class v {
                    ...
                    setupControls() {
                        ...
                        e.inputSets.length && e.inputSets.forEach((e, t) => {
                            ...
                            r = r || Object(p.n)(o), e.icon && (o = `<span class="control-icon">${e.icon}</span>${o}`);
                    ...
                    orderFields(e) {
                        ...
                        let o;
                        return window.sessionStorage && (t.sortableControls ? o = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), o ? (o = window.JSON.parse(o), o = Object(p.B)(o.concat(e)), o = Object.keys(o).map(e => o[e])) : o = Object(p.B)(r), o.forEach(e => {
                ...
                const k = function (e, t, r) {
                    ...
                    e.showActionButtons && S.appendChild(b.formActions), N.append(b.stage, S), "textarea" !== t.type ? r(t).append(N) : r(t).replaceWith(N), r(b.controls).on("click", "li", ({
                        target: e
                    }) => {
                    ...
                    o.prepFieldVars = L;
                    const D = function (t) {
                            (t = g.getData(t)) && t.length ? (t.forEach(e => L(Object(p.A)(e))), b.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? g.addDefaultFields() : e.prepend || e.append || (b.stage.classList.add("empty"), b.stage.dataset.content = d.a.get("getStarted")), (() => {
                                const t = [],
                                    o = t => O("li", e[t], {
                                        className: "disabled-field form-" + t
                                    });
                                return e.prepend && !r(".disabled-field.form-prepend", b.stage).length && (t.push(!0), q.prepend(o("prepend"))), e.append && !r(".disabled-field.form-.append", b.stage).length && (t.push(!0), q.append(o("append"))), g.disabledTT(b.stage), t.some(e => !0 === e)
                            })() && b.stage.classList.remove("empty"), g.save()
                        },
                        T = t => {
                            const {
                                type: r
                            } = t, o = [], n = j.getClass(r), i = (e => {
                                ...
                                access: () => {
                                    ...
                                    for (a in e.roles)
                                        if (e.roles.hasOwnProperty(a)) {
                                            ...
                                            s.includes(a) && (o.checked = "checked"), r.push(`<label for="${t}">`), r.push(g.input(o).outerHTML), r.push(` ${e.roles[a]}</label>`)
                                        } r.push("</div>");
                                    const o = {
                                        first: d.a.get("roles"),
            ...
            } < /div>`}</div > `}function P(e,t){const{multiple:r,options:o,label:i,value:l,class:a,className:s}=t,u=x(t,["multiple","options","label","value","class","className"]),f=Object.keys(o).map(e=>{const t={value:e},r=o[e],n=Array.isArray(r)?d.a.get(...r)||r[0]:r;return(Array.isArray(l)?l.includes(e):e===l)&&(t.selected=null),O("option",n,t)}),p={id:`
            $ {
                e
            } - $ {
                c.lastID
            ...
            for = "${p.id}" > $ {
                n[e]
            } < /label>`;Object.keys(u).forEach((function(e){p[e]=u[e]}));return`<div class="form-group ${e}-wrap">${m}${`<div class="input-wrap">${O("select",f,p).outerHTML}</div > `}</div>`
        }
        const M = (e, t, r = {}) => {
            const o = t => O("label", t, {
                    for: `${e}-${c.lastID}`
            ...
            return t += g.input({
                ...
                type: "hidden",
                className: "btn-style"
            }).outerHTML, t += '<div class="btn-group" role="group">', m.d.btn.forEach(r => {
            ...
            if (![].some(e => !0 === e)) {
                ...
                "label" !== t || e.disableHTMLLabels ? (n.value = i, n.type = "text", s += `<input ${Object(p.b)(n)}>`) : (n.contenteditable = !0, s += O("div", i, n).outerHTML);
