...
return [
     ...
     * Optional new settings. If these settings do not exist in a previous version of CRMLite, a user can simply add them
     ...
     *      this will allow for using the configs in the application as if they exist for all version of CRMLite
